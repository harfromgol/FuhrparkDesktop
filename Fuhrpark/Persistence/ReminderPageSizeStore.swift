...
/// Speichert die zuletzt gewählte Seitengröße der Erinnerungsliste
/// (`ReminderListWindow`) in den UserDefaults, damit die Einstellung einen
/// Neustart der App übersteht – analog zu `NotePageSizeStore`.
enum ReminderPageSizeStore {
    private static let defaultsKey = "reminderListPageSize"
